...
class HasTrainer_DP_dense_3_branch(nnUNetTrainerV2_3_branch):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=1, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_dense_3_branch, self).__init__(plans_file, fold, output_folder, dataset_directory,
                                                           batch_dice, stage,
    ...
    def setup_DA_params(self):
        super(HasTrainer_DP_dense_3_branch, self).setup_DA_params()
    ...
    def process_plans(self, plans):
        super(HasTrainer_DP_dense_3_branch, self).process_plans(plans)
        if not self.distribute_batch_size:
            ...
            print("self.plans['plans_per_stage'][self.stage]['batch_size']: ",
                  self.plans['plans_per_stage'][self.stage]['batch_size'])
            print("")
    ...
    def initialize_network(self):
        ...
        # self.network = DenseUNet_DP_3(self.num_input_channels, self.base_num_features, self.num_classes,
